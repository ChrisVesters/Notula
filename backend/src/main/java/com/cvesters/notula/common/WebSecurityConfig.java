...
public class WebSecurityConfig {
        ...
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/actuator/health/**")
                                ...
                                .permitAll()
                                .requestMatchers("/v2/api-docs", "/v3/api-docs", "/configuration/ui", "/swagger-resources", "/configuration/security", "/swagger-ui.html", "/webjars/**", "/swagger-resources/configuration/ui", "/swagger-resources/configuration/security")
                                .permitAll()
                                .anyRequest()
                                .authenticated())
    ...
    @Bean
    Converter<Jwt, ? extends AbstractAuthenticationToken> customAuthConverter() {
        ...
        return jwt -> {
            ...
            Integer practiceId = Integer.parseInt(jwt.getClaimAsString("practiceId"));
